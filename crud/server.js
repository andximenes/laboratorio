...
app.use.static("public")// express servindo os arquivos estáticos da pasta "public". Isso significa que qualquer arquivo colocado nessa pasta pode ser acessado diretamente pelo navegador, como por exemplo: http://localhost:3000/arquivo.html. É uma maneira fácil de servir arquivos como HTML, CSS, JavaScript, imagens, etc., sem precisar criar rotas específicas para cada um deles.
